...
def generate_links(storage_account_ids, default_domain):
    base_url = "https://portal.azure.com/#@domain.com/resourceidfromstorage/accountEncryption"
...
def main():
    ...
    message = (
        ...
        "Manual check required for 4.11 Ensure Storage for Critical Data are Encrypted with Customer Managed Keys (CMK)" +
        Style.RESET_ALL
    )
    print(message)
